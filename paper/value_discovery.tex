...
This paper contributes four things towards testing this hypothesis: an
operationalization of it, an instrument built around that operationalization, a map of
the instrument's limits, and a set of mechanism-level findings made along the way.
(1)~An operationalization of our hypothesis, the \emph{value signature}, with
...
(2)~An instrument for unsupervised value discovery: directed-information scores
...
(3)~A characterization of the instrument's limits by adversarial impostors, together
...
floor: ``levers the world, unlevered by the world'') is the value signature restated
under access. Its construction was itself instructive: the XOR cipher bit three times (an
...
cannot be stated at all, while the passive value signature runs. The active-vs-passive
